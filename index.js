...
const questions = [
    ...
    },
    {
        ...
        options: [
            'Create a new file (.js) and link the src of the file inside the HTML code.',
            'Write your JavaScript Code inside the script tag.',
            'None of these',
            'Both a & b'
        ],
        answer: '3',
    ...
    {
        title: 'How to define objects in JS?',
        options: [
            '[]',
            '{}',
            'object = ',
    ...
    },
    {
        ...
        options: [
            'Hyper Translation Mannual Language',
    ...
    {
        title: 'Full form of AJAX ?',
        options: [
            'Addition Javascript And XML',
            'Alone Javascript and XML',
            'No full form',
